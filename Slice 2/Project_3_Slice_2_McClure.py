{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "26/04/30 12:26:08 WARN NativeCodeLoader: Unable to load native-hadoop library for your platform... using builtin-java classes where applicable\n",
      "26/04/30 12:26:09 WARN Utils: Service 'SparkUI' could not bind on port 4040. Attempting port 4041.\n",
      "26/04/30 12:26:09 WARN Utils: Service 'SparkUI' could not bind on port 4041. Attempting port 4042.\n",
      "26/04/30 12:26:09 WARN Utils: Service 'SparkUI' could not bind on port 4042. Attempting port 4043.\n",
      "26/04/30 12:26:09 WARN Utils: Service 'SparkUI' could not bind on port 4043. Attempting port 4044.\n"
     ]
    },
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "id": "f74a7ecd-52e5-477c-a900-a7395f6e6094",
   "metadata": {},
   "outputs": [],
   "source": []
  }
